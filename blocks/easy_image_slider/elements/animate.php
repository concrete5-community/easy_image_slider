...
<optgroup label="<?php echo t('Attention Seekers') ?>">
...
<optgroup label="<?php echo t('Bouncing Entrances') ?>">
...
<optgroup label="<?php echo t('Bouncing Exits') ?>">
...
<optgroup label="<?php echo t('Fading Entrances') ?>">
...
<optgroup label="<?php echo t('Fading Exits') ?>">
...
<optgroup label="<?php echo t('Flippers') ?>">
...
<optgroup label="<?php echo t('Lightspeed') ?>">
...
<optgroup label="<?php echo t('Rotating Entrances') ?>">
...
<optgroup label="<?php echo t('Rotating Exits') ?>">
...
<optgroup label="<?php echo t('Sliding Entrances') ?>">
...
<optgroup label="<?php echo t('Sliding Exits') ?>">
...
<optgroup label="<?php echo t('Zoom Entrances') ?>">
...
<optgroup label="<?php echo t('Zoom Exits') ?>">
...
<optgroup label="<?php echo t('Specials') ?>">
